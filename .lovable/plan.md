...
```text
usuarios (UsuarioID, UsuarioNombre, UsuarioEmail unico, UsuarioContraseniaHash, Rol, Activo)
    | 1
...
- `usuarios` concentra nombre, email y contraseña hasheada (hoy repartidos en `clientes`).
